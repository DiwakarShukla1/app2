(function(angular) {
    ...
    var allMappings = {
        ...
        coreDrawerPanel: responsiveMappings,
        coreSelector: selectorMappings,
        coreMediaQuery: queryMatchings,
        coreAnimatedPages: selectorMappings,
        topekaApp: userMatchings,
        paperSlider: {
            ngModel: {
                primitive: 'value'
            },
    ...
    // document.getElementsByTagName('html').array().forEach(function(element) {
    ...
    var delement = document.getElementsByTagName('html')[0];
    var app = delement.getAttribute('ng-app');
    delement.removeAttribute('ng-app');

    function bootstrap(){
        angular.bootstrap(wrap(delement),  [app]);
